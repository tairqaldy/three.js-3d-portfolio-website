    ...
    <section className="text-hero" id="home">
      ...
      <div className="text-hero-container">
        ...
        <p>
          ...
          — sometimes tools, sometimes systems, sometimes experiments that get out of hand and turn into startups.
        </p>
        ...
        {/* right now i'm studying software engineering at fontys ict (nl)
         and developing <span className="text-white">ai360</span> (by <span className="text-white">qaldy ai</span>)
          — The purpose of the project is to lower the technical threshold for implementing automation
        ...
        <div className="social-links">
          <a href="https://x.com/tairkaldybayev" target="_blank" rel="noopener noreferrer">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
            <span>@tairkaldybayev</span>
          </a>
          ...
          <a href="https://youtube.com/tairqaldy" target="_blank" rel="noopener noreferrer">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.linkedin.com/in/tair-kaldybayev-922198312/" target="_blank" rel="noopener noreferrer">
            <svg width="16" height="16" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
