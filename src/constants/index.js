...
export const workExperiences = [
  {
    ...
    pos: 'HBO ICT Student (Software Engineering)',
    duration: '2025 september — Present',
    title: "Currently studying ICT in the HBO (University of Applied Sciences) system at Fontys, Netherlands. HBO education is practice-oriented, combining theory with real-world projects. Here I develop web, AI, and software engineering projects in collaboration with peers, focusing on problem-solving, teamwork, and building production-ready solutions.",
  ...
  },
  {
    id: 2,
    name: 'Qaldy AI',
    pos: 'AI Expert / Full-Stack Developer',
    duration: '2023 november — 2025 august',
    title: "Developed AI-powered change-management educational platforms. Example: BizDevKz (Gemini API powered hypotheses, risk & implementation business development planning). Built with HTML/CSS/JS, deployed on hoster.kz + ps.kz, and secured by login/password access to control usage during client sessions. for hypothesis, force-field & risk analysis and implementation planning; HTML/CSS/JS frontend; deployed on hoster.kz + ps.kz; password-protected.",
    icon: '/assets/qaldyai.png',
    animation: 'clapping',
  },
  {
    id: 3,
    ...
    duration: '2023 september — 2023 november.',
